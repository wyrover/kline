  ...
  constructor() {
    ...
    let ADX = new exprs.OutputExpr(
      ...
      new exprs.ExpmemaExpr(
        new exprs.MulExpr(
          new exprs.DivExpr(
            new exprs.AbsExpr(new exprs.SubExpr(MDI, PDI)),
    ...
    let TRIX = new exprs.OutputExpr(
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.SubExpr(
            MTR,
            new exprs.RefExpr(MTR, new exprs.ConstExpr(1))
          ),
          new exprs.RefExpr(MTR, new exprs.ConstExpr(1))
        ),
        new exprs.ConstExpr(100)
  ...
  constructor() {
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.SumExpr(
            new exprs.MaxExpr(
              new exprs.ConstExpr(0),
              new exprs.SubExpr(new exprs.HighExpr(), REF_CLOSE_1)
            ),
            N
          ),
          new exprs.SumExpr(
            new exprs.MaxExpr(
              new exprs.ConstExpr(0),
              new exprs.SubExpr(REF_CLOSE_1, new exprs.LowExpr())
            ),
            N
          )
        ),
    ...
    let AR = new exprs.OutputExpr(
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.SumExpr(
            new exprs.SubExpr(new exprs.HighExpr(), new exprs.OpenExpr()),
            N
          ),
          new exprs.SumExpr(
            new exprs.SubExpr(new exprs.OpenExpr(), new exprs.LowExpr()),
            N
          )
        ),
        new exprs.ConstExpr(100)
...
export class VRIndicator extends Indicator {
  constructor() {
    ...
    let TL = new exprs.AssignExpr(
      ...
      new exprs.SumExpr(
        new exprs.IfExpr(
          new exprs.LtExpr(new exprs.CloseExpr(), REF_CLOSE_1),
          new exprs.VolumeExpr(),
          new exprs.ConstExpr(0)
        ),
        N
    ...
    let VR = new exprs.OutputExpr(
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.AddExpr(new exprs.MulExpr(TH, new exprs.ConstExpr(2)), TQ),
          new exprs.AddExpr(new exprs.MulExpr(TL, new exprs.ConstExpr(2)), TQ)
        ),
        new exprs.ConstExpr(100)
      )
    );
...
export class WRIndicator extends Indicator {
  constructor() {
    ...
    let WR1 = new exprs.OutputExpr(
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.SubExpr(HHV, new exprs.CloseExpr()),
          new exprs.SubExpr(HHV, LLV)
        ),
        new exprs.ConstExpr(100)
      )
    );
    ...
    let WR2 = new exprs.OutputExpr(
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.SubExpr(HHV1, new exprs.CloseExpr()),
          new exprs.SubExpr(HHV1, LLV1)
        ),
        new exprs.ConstExpr(100)
      )
    );
...
export class KDJIndicator extends Indicator {
  constructor() {
    ...
    let RSV = new exprs.AssignExpr(
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.SubExpr(new exprs.CloseExpr(), LLV),
          new exprs.SubExpr(HHV, LLV)
        ),
        new exprs.ConstExpr(100)
      )
...
export class ROCIndicator extends Indicator {
  constructor() {
    ...
    let ROC = new exprs.OutputExpr(
      ...
      new exprs.MulExpr(
        new exprs.DivExpr(
          new exprs.SubExpr(new exprs.CloseExpr(), REF_CLOSE_N),
          REF_CLOSE_N
        ),
        new exprs.ConstExpr(100)
      )
